...
# npm run dev "./goal-model-examples/Exemplo Object Picking/Object Picking.hddl"\
...
# npm run dev "./examples/Day Life In Nursing Homes/hddl/DayLifeInNursingHomes.hddl"\
...
# npm run dev "./examples/Food Logistics/hddl/FoodLogistics.hddl"\
