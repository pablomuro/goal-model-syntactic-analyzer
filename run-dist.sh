...
# ./goal-model-syntactic-analyzer "../examples/Day Life In Nursing Homes/hddl/DayLifeInNursingHomes.hddl"\
...
# ./goal-model-syntactic-analyzer "../examples/Deliver Goods - Equipment/hddl/DeliverGoodsEqupments.hddl"\
...
# ./goal-model-syntactic-analyzer "../examples/Food Logistics/hddl/FoodLogistics.hddl"\
...
# ./goal-model-syntactic-analyzer "../examples/Keeping Clean/hddl/Keeping Clean.hddl"\
#  "../examples/Keeping Clean/gm/Keeping Clean.txt"\
#  "../examples/Keeping Clean/configuration/configuration.json"

# Lab Samples Logistics

# ./goal-model-syntactic-analyzer "../examples/Lab Samples Logistics/hddl/LabSampleLogistics.hddl"\
#  "../examples/Lab Samples Logistics/gm/LabSampleLogistics.txt"\
#  "../examples/Lab Samples Logistics/configuration/configuration.json"

# Seizure Recognition

# ./goal-model-syntactic-analyzer "../examples/Seizure Recognition/hddl/SeizureRecognition.hddl"\
